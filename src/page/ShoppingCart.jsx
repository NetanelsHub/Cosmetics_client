...
export default function ShoppingCart() {
  ...
  const { setShowModelProfile, setShowDropdownMenu, setIsLogIn } =
  ...
  useEffect(() => {
    ...
    const total = shoppingList.reduce(
      (sum, val) => sum + val.product_price * val.quantity,
      0
    );
    setTotalPrice(total);
  ...
  return (
    <>
      <Model onClick={handlerClosModel} show={showModelCart}>
        {/* add card */}
        <div className="pt-2" style={{ maxHeight: "40vh", overflowY: "auto" }}>
          {/* Header */}
          ...
          <div className="h-[20vh]">
            {shoppingList.length > 0 ? (
              shoppingList.map((val, index) => (
                <div
                  key={index}
                  className=" border rounded-lg p-2 flex items-center space-x-4"
                >
                  <img
                  ...
                  <div className="flex-grow">
                    <h3 className="text-m font-bold">{val.product_name}</h3>
                    ...
                    <div className="flex items-center space-x-2 mt-2">
                      ...
                      <button
                        ...
                        className="text-red-500 mt-2 pl-8  ml-auto "
                      >
                        Remove
                      </button>
                    </div>
          ...
          <div className="mt-4 flex flex-col">
            <Bill>
              <div className="flex  ">
                ...
                <button
                  className="mt-4 ml-auto text-white bg-gray-900 hover:bg-customGold focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  onClick={handelClose}
                >
                  Back to shopping
                </button>
